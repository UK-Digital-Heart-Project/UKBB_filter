####FOR SEARCHING THE DATABASE TIDIED TO INCLUDE ONLY RELEVANT ICD COLS####
...
#open data.table
bb <- fread("filepath", header=TRUE, sep="\t", fill=TRUE)
...
df <- bind_cols(select_eid, select_40001, select_40002, select_41202, select_41204,select_41203, select_41205,select_20002, select_20004)
...
I50.9_row <- I50.9[,1]
hf_icd10_total <- c(I11.0_row, I13.0_row, I13.2_row, I25.5_row, I42.0_row, I42.5_row, I42.8_row, I42.9_row, I50.0_row, I50.1_row, I50.9_row)
...
I4289_row <- I4289[,1]
hf_icd9_total <- c(I4254_row, I4280_row, I4281_row, I4289_row, I425_row, I428_row)
...
hf_total <- c(hf_icd10_total_unique, hf_icd9_total_unique, hf_interview_total_unique)
hf_total_unique_with_hcm <- unique(hf_total)
hf_total_unique <- setdiff(hf_total_unique_with_hcm, hcm_total_unique)

###### NEED TO CHANGE from I21, I22, I23, https://biobank.ctsu.ox.ac.uk/crystal/coding.cgi?id=19&nl=1 - READ THE NATURE GENETICS PAPER#####
...
I25.2_row <- I25.2[,1]
cad_icd10_total <- c(I21.0_row,I21.1_row,I21.2_row,I21.3_row,I21.4_row,I21.9_row,I22.0_row,I22.1_row,I22.8_row,I22.9_row,I25.2_row)
...
cad_interview_total <- c(cad_interview2_row, cad_interview3_row, cad_interview4_row, cad_interview5_row)
...
#Pooled CAD
cad_total <- c(cad_icd10_total_unique, cad_icd9_total_unique, cad_interview_total_unique, cad_dr_row)
...
# 
# htn_total <- c(htn_icd10_total_unique, htn_icd9_total_unique, htn_interview_total_unique)
...
E11.9_row <- E11.9[,1]
#
t2dm_icd10_total <- c(E11.0_row,E11.1_row,E11.2_row,E11.3_row,E11.4_row,E11.5_row,E11.6_row,E11.7_row,E11.8_row,E11.9_row)
...
diabetes_other <- c(E10.0_row,E10.1_row,E10.2_row,E10.3_row,E10.4_row,E10.5_row,E10.6_row,E10.7_row,E10.8_row,E10.9_row,E14.0_row,E14.1_row,E14.2_row,E14.3_row,E14.4_row,E14.5_row,E14.6_row,E14.7_row,E14.8_row,E14.9_row)
...
#E100 to E109, E130 to 149
#
#df[htn_total_unique, 1]
#str(htn_total_unique)
#
df[t2dm_total_unique, 1]
str(t2dm_total_unique)
...
# 
# af_total <- c(I48_row, I48.0_row, I48.1_row, I48.2_row, I48.3_row, I48.4_row, I48.9_row, I4273_row,af_interview1_row,af_interview2_row,af_interview3_row )
...
aragam_nicm_total_unique <- setdiff(aragam_nicm_total_unique_with_hcm, hcm_total_unique)
aragam_nicm_pop <- setdiff(aragam_nicm_total_unique, cad_total_unique)

# NICM as per SLZ definition
sz_nicm_total <- c(I42.0_row, I50.1_row, I50.0_row, I50.9_row, hf_icd9_total, hf_interview_total)
